package TagLib::ID3v2::FrameList;
...
TagLib::ID3v2::FrameList - Perl-only class
...
This implements TagLib::ID3v2::FrameList in C/C++ code, which is of
type TagLib::ListE<lt>TagLib::ID3v2::Frame *E<gt>. The list is
copy-on-write. 
...
=item I<new(L<FrameList|TagLib::ID3v2::FrameList> $l)>
...
=item I<L<Iterator|TagLib::ID3v2::FrameList::Iterator> begin()>

Returns an STL style iterator to the beginning of the list.

=item I<L<Iterator|TagLib::ID3v2::FrameList::Iterator> end()>

Returns an STL style iterator to the end of the list.

=item I<void insert(L<Iterator|TagLib::ID3v2::FrameList::Iterator>
$it, L<Frame|TagLib::ID3v2::Frame> $value)>n

Insert a copy of $value before $it.

=item I<void sortedInsert(L<Frame|TagLib::ID3v2::Frame> $value, BOOL
$unique = FALSE)>
...
=item I<L<Iterator|TagLib::ID3v2::FrameList::Iterator>
find(L<Frame|TagLib::ID3v2::Frame> $value)>

Finds the first occurance of $value.

=item I<BOOL contains(L<Frame|TagLib::ID3v2::Frame> $value)>

Returns true if the list contains $value.

=item I<void erase(L<Iterator|TagLib::ID3v2::FrameList::Iterator>
$it)> 

Erase the item at $it from the list.

=item I<L<Frame|TagLib::ID3v2::Frame> front()>

Returns the first item in the list.

=item I<L<Frame|TagLib::ID3v2::Frame> back()>
...
=item I<L<Frame|TagLib::ID3v2::Frame> getItem(UV $i)>
...
=item I<L<FrameList|TagLib::ID3v2::FrameList>
copy(L<FrameList|TagLib::ID3v2::FrameList> $l)>
