...
=item I<new(L<ByteVector|TagLib::ByteVector> $v)>
...
=item I<L<ByteVector|TagLib::ByteVector> mid(UV $index, UV $length =
0xffffffff)> 
...
=item I<IV find(L<ByteVector|TagLib::ByteVector> $pattern, UV $offset
= 0, IV $byteAlign = 1)>
...
=item I<IV rfind(L<ByteVector|TagLib::ByteVector> $pattern, UV $offset
= 0, IV $byteAlign = 1)>
...
=item I<BOOL containsAt(L<ByteVector|TagLib::ByteVector> $pattern, UV
...
=item I<BOOL startsWith(L<ByteVector|TagLib::ByteVector> $pattern)>

Returns true if the vector starts with $pattern.

=item I<BOOL endsWith(L<ByteVector|TagLib::ByteVector> $pattern)>

Returns true if the vector ends with $pattern.

=item I<IV endsWithPartialMatch(L<ByteVector|TagLib::ByteVector>
$pattern)> 
...
=item I<void append(L<ByteVector|TagLib::ByteVector> $v)>
...
=item I<L<ByteVector|TagLib::ByteVector> resize(UV $size, PV padding =
0)>
...
=item I<L<Iterator|TagLib::ByteVector::Iterator> begin()>

Returns an Iterator that points to the front of the vector.

=item I<L<Iterator|TagLib::ByteVector::Iterator> end()>
...
=item I<L<ByteVector|TagLib::ByteVector> fromUInt(UV $value, BOOL
...
=item I<L<ByteVector|TagLib::ByteVector> fromShort(IV $value, BOOL
...
=item I<L<ByteVector|TagLib::ByteVector> fromLongLong(IV $value, BOOL
$mostSignificantByteFirst = true)> [static]
...
=item I<L<ByteVector|TagLib::ByteVector> fromCString(PV $s, UV $length
= 0xffffffff)> [static]
...
=item I<copy(L<ByteVector|TagLib::ByteVector> $v)>

Inplements operator=. 

=item I<L<ByteVector|TagLib::ByteVector> null()> [static]

Returns the static object TagLib::ByteVector::null.
