package TagLib::Ogg::Vorbis::Properties;
...
BEGIN : 
  {
      ...
      unless (grep {/^new$/ } keys %__PACKAGE__::) {
          *TagLib::Ogg::Vorbis::Properties:: = *TagLib::Vorbis::Properties:: ;
      }
  }
...
TagLib::Ogg::Vorbis::Properties  - An implementation of audio property
...
=head1 SYNOPSIS
  ...
  my $f = TagLib::Ogg::Vorbis::File->("sample ogg file.ogg");
...
=item I<new(L<File|TagLib::Ogg::Vorbis::File> $file, PV $style =
"Average")> 
