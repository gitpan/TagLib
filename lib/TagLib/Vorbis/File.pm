...
BEGIN : 
  {
      ...
      unless (grep {/^new$/ } keys %__PACKAGE__::) {
          *TagLib::Vorbis::File:: = *TagLib::Ogg::Vorbis::File:: ;
...
TagLib::Vorbis::File - An implementation of Ogg::File with Vorbis
specific methods 
...
=head1 SYNOPSIS
  ...
  my $i = TagLib::Vorbis::File->new("sample vorblis file.ogg");
...
=item I<L<Properties|TagLib::Vorbis::Properties>
audioProperties()>
