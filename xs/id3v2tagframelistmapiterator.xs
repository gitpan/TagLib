...
CODE:
	...
	case 2:
		if(sv_isobject(ST(1)) && 
			sv_derived_from(ST(1), "TagLib::ID3v2::FrameListMap::Iterator"))
			i = INT2PTR(TagLib::ID3v2::FrameListMap::Iterator *, SvIV(SvRV(ST(1))));
		else
			croak("ST(1) is not of type TagLib::ID3v2::FrameListMap::Iterator");
...
//USEPAIR
	...
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "TagLib::ID3v2::FrameList", (void *)&data);
...
PPCODE:
	...
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "TagLib::ID3v2::FrameListMap::Iterator", (void *)&i);
	SvREADONLY_on(SvRV(ST(0)));
	XSRETURN(1);
...
PPCODE:
	...
	//ST(0) = sv_newmortal();
	//sv_setref_pv(ST(0), "TagLib::ID3v2::FrameListMap::Iterator", (void *)THIS);
	//SvREADONLY_on(SvRV(ST(0)));
	XSRETURN(1);
