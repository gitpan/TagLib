...
CODE:
	...
	case 2:
		if(sv_isobject(ST(1)) && 
			sv_derived_from(ST(1), "TagLib::ID3v2::FrameList::Iterator"))
			i = INT2PTR(TagLib::ID3v2::FrameList::Iterator *, SvIV(SvRV(ST(1))));
		else
			croak("ST(1) is not of type TagLib::ID3v2::FrameList::Iterator");
...
//USELIST
	...
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "TagLib::ID3v2::Frame", (void *)data);
...
PPCODE:
	...
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "TagLib::ID3v2::FrameList::Iterator", (void *)&i);
	SvREADONLY_on(SvRV(ST(0)));
	XSRETURN(1);
...
PPCODE:
	...
	//ST(0) = sv_newmortal();
	//sv_setref_pv(ST(0), "TagLib::ID3v2::FrameList::Iterator", (void *)THIS);
	//SvREADONLY_on(SvRV(ST(0)));
	XSRETURN(1);
