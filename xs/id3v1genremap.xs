...
CODE:
	...
	case 2:
		if(sv_isobject(ST(1)) && 
			sv_derived_from(ST(1), "TagLib::ID3v1::GenreMap"))
...
PPCODE:
	/*! 
	 * tie %h, "TagLib::ID3v1::GenreMap"
	 * tie %h, "TagLib::ID3v1::GenreMap", $obj_to_tie
	 */
	switch(items) {
	case 2:
		if(sv_isobject(ST(1)) && 
	...
	sv_bless(refobj, gv_stashpv("TagLib::ID3v1::GenreMap", TRUE));
	ST(0) = refobj;
	XSRETURN(1);
