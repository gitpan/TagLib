...
BEGIN { use_ok('TagLib::ID3v2::Header') };
...
can_ok("TagLib::ID3v2::Header", @methods) 							or 
	diag("can_ok failed");

my $i = TagLib::ID3v2::Header->new();
my $data = TagLib::ByteVector->new("blah blah");
my $j = TagLib::ID3v2::Header->new($data);
isa_ok($i, "TagLib::ID3v2::Header") 								or 
	diag("method new() failed");
isa_ok($j, "TagLib::ID3v2::Header") 								or 
