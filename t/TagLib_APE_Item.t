...
isEmpty);
can_ok("TagLib::APE::Item", @methods) 					or 
	diag("can_ok failed");

ok(TagLib::APE::Item->new()->isEmpty()) 				or 
	diag("method new() failed");
my $key    = TagLib::String->new("test");
my $value  = TagLib::String->new("This is a test");
my $values = TagLib::StringList->new($value);
my $i      = TagLib::APE::Item->new($key, $value);
my $j      = TagLib::APE::Item->new($key, $values);
my $k      = TagLib::APE::Item->new($i);
my $l      = TagLib::APE::Item->new();
