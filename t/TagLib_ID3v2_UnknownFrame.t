...
BEGIN { use_ok('TagLib::ID3v2::UnknownFrame') };
...
can_ok("TagLib::ID3v2::UnknownFrame", @methods) 					or 
	diag("can_ok failed");

my $i = TagLib::ID3v2::UnknownFrame->new(TagLib::ByteVector->new(""));
isa_ok($i, "TagLib::ID3v2::UnknownFrame") 							or 
