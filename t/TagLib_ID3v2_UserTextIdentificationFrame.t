...
BEGIN { use_ok('TagLib::ID3v2::UserTextIdentificationFrame') };
...
can_ok("TagLib::ID3v2::UserTextIdentificationFrame", @methods) 		or 
	diag("can_ok failed");

my $i = TagLib::ID3v2::UserTextIdentificationFrame->new();
isa_ok($i, "TagLib::ID3v2::UserTextIdentificationFrame") 			or 
...
$i->setDescription(TagLib::String->new("desc"));
