...
# `perl TagLib_Ogg_Vorbis_Properties.t'
...
BEGIN { use_ok('TagLib::Ogg::Vorbis::Properties') };
...
can_ok("TagLib::Ogg::Vorbis::Properties", @methods) 					or 
	diag("can_ok failed");


my $file = "sample/Discontent.ogg";
my $oggfile = TagLib::Vorbis::File->new($file);
my $i = $oggfile->audioProperties();
isa_ok($i, "TagLib::Ogg::Vorbis::Properties") 						or 
	diag("method TagLib::Ogg::Vorbis::audioProperties() failed");
