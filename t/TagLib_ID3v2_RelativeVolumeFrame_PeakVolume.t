...
BEGIN { use_ok('TagLib::ID3v2::RelativeVolumeFrame::PeakVolume') };
...
can_ok("TagLib::ID3v2::RelativeVolumeFrame::PeakVolume", @methods) 	or 
	diag("can_ok failed");

my $i = TagLib::ID3v2::RelativeVolumeFrame::PeakVolume->new();
isa_ok($i, "TagLib::ID3v2::RelativeVolumeFrame::PeakVolume") 		or 
...
$i->setPeakVolume(TagLib::ByteVector->new("blah blah"));
