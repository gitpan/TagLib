...
BEGIN { use_ok('TagLib::ByteVector::Iterator') };
...
can_ok("TagLib::ByteVector::Iterator", @methods) or diag("can_ok failed");

my $v = TagLib::ByteVector->new("blah blah blah");
my $i = $v->begin();
isa_ok($i, "TagLib::ByteVector::Iterator") 						or 
	diag("method TagLib::ByteVector::begin() failed");
isa_ok(TagLib::ByteVector::Iterator->new(), 
	"TagLib::ByteVector::Iterator") 							or 
	diag("method new() failed");
isa_ok(TagLib::ByteVector::Iterator->new($i), 
	"TagLib::ByteVector::Iterator") 							or 
