...
BEGIN { use_ok('TagLib::ID3v2::UniqueFileIdentifierFrame') };
...
can_ok("TagLib::ID3v2::UniqueFileIdentifierFrame", @methods) 		or 
	diag("can_ok failed");

my $owner = TagLib::String->new("owner");
my $id = TagLib::ByteVector->new("id");
my $i = TagLib::ID3v2::UniqueFileIdentifierFrame->new($owner, $id);
isa_ok($i, "TagLib::ID3v2::UniqueFileIdentifierFrame") 				or 
...
my $newowner = TagLib::String->new("newowner");
my $newid = TagLib::ByteVector->new("newid");
$i->setOwner($newowner);
