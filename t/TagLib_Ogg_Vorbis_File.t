...
BEGIN { use_ok('TagLib::Ogg::Vorbis::File') };
...
can_ok("TagLib::Ogg::Vorbis::File", @methods) 					or 
	diag("can_ok failed");

my $file = "sample/Discontent.ogg";
my $i = TagLib::Ogg::Vorbis::File->new($file);
isa_ok($i, "TagLib::Ogg::Vorbis::File") 						or 
	diag("method new(file) failed");
isa_ok($i->tag(), "TagLib::Ogg::XiphComment") 				or 
	diag("method tag() failed");
isa_ok($i->audioProperties(), "TagLib::Ogg::Vorbis::Properties") or 
