...
BEGIN { use_ok('TagLib::ID3v2::RelativeVolumeFrame') };
...
can_ok("TagLib::ID3v2::RelativeVolumeFrame", @methods) 				or 
	diag("can_ok failed");
TODO: {
local $TODO = "TagLib::ID3v2::RelativeVolumeFrame() not implemented";
#isa_ok(TagLib::ID3v2::RelativeVolumeFrame->new(), 
#	"TagLib::ID3v2::RelativeVolumeFrame") 							or 
#	diag("method new() failed");
}
my $i = TagLib::ID3v2::RelativeVolumeFrame->new(
	TagLib::ByteVector->new());
isa_ok($i, "TagLib::ID3v2::RelativeVolumeFrame") 					or 
...
my $peak = TagLib::ID3v2::RelativeVolumeFrame::PeakVolume->new();
#$peak->setBitsRepresentingPeak(20);
#$peak->setPeakVolume(TagLib::ByteVector->new("blah blah"));
$i->setPeakVolume($peak);
isa_ok($i->peakVolume(), 
	"TagLib::ID3v2::RelativeVolumeFrame::PeakVolume") 				or 
