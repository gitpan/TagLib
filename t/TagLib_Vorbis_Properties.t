...
BEGIN { use_ok('TagLib::Vorbis::Properties') };
...
can_ok("TagLib::Vorbis::Properties", @methods) 						or 
	diag("can_ok failed");

my $file = "sample/Discontent.ogg";
my $oggfile = TagLib::Vorbis::File->new($file);
my $i = $oggfile->audioProperties();
isa_ok($i, "TagLib::Vorbis::Properties") 							or 
	diag("method TagLib::Vorbis::audioProperties() failed");
